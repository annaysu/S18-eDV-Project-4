# Change "newplot1", all __4_s, and edit tiles below:
tabItem(tabName = "Newplot",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
             textInput("title__4_", "Title 1", "Department Age"),
             numericInput("titleFont__4_", "Title Font", 10)), 
          tabPanel("Plot Legend",
             textInput("legendTitle__4_", "Legend Title", "Department Legend"),
             numericInput("legendTitleSize__4_", "Legend Title Size", 10),
             numericInput("legendItemSize__4_", "Legend Item Size", 9),
             numericInput("legendKeySize__4_", "Legend Key Size", 5)), 
          tabPanel("Axis Labels",
             textInput("xLabel__4_", "x-Axis Label", "Age"),
             textInput("yLabel__4_", "y-Axis Label 1", "Age Count"),
