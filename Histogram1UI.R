...
tabItem(tabName = "Histogram",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
                   textInput("title__1_", "Title 1", "Monthly Income Costs"),
                   numericInput("titleFont__1_", "Title Font", 10)), 
          tabPanel("Plot Legend",
                   textInput("legendTitle__1_", "Legend Title", "Department Legend"),
                   numericInput("legendTitleSize__1_", "Legend Title Size", 10),
                   numericInput("legendItemSize__1_", "Legend Item Size", 9),
