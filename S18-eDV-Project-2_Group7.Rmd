...
ui <- dashboardPage( skin = "green",
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("Monthly Income Density Plot", tabName = "density", icon = icon("asymmetrik")),
      menuItem("Shipping Costs Histogram and Density Plot", tabName = "both", icon = icon("asymmetrik")),
      menuItem("Sales Histogram", tabName = "newplot", icon = icon("asymmetrik"))
    )
  ),
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "histogram",
        p("This histogram shows the monthly income found in our data."),
        source("Histogram1UI.R",local = TRUE)$value
      ),
      # 2. "Monthly Income Density Plot" tab content
